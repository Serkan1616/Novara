...
const NavBar = () => {
  return (
    <>
      <nav className="z-50 bg-white/90 backdrop-blur-sm shadow-[0_2px_10px_rgba(0,0,0,0.1)] transition-all duration-300">
        <div className="max-w-7xl mx-auto py-4 px-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden lg:flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-gray-100 transition-colors duration-200 cursor-pointer">
